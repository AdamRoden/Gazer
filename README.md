...
2. Dwell a cell until progress completes. Last dwell step repeats while gaze holds. Typing, mouse, composer typing, modifiers, and AHK use **daily driver dwell**; settings, navigation, and composer word chips use **designer dwell**. Both are under Settings → Speed.
