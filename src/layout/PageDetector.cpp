...
{
    const QRectF progress = PageDimParse::placeRect(bounds, z.anchor, z.offset, z.size);
    ...
    const QRectF dwell = PageDimParse::placeRect(progress, z.anchor, dwellOffset, dwellSize);
