...
bool resolveActiveState(const ActiveStateContext& ctx, const QString& key)
{
    ...
    static const struct {
        ...
        {"settings.flash.custom.toggle", [](const AppSettings& s) { return s.flashCustom; }},
        {"settings.hover.custom.toggle", [](const AppSettings& s) { return s.hoverCustom; }},
        ...
        {"settings.session.showSplash.toggle",
         [](const AppSettings& s) { return s.showSplash; }},
        ...
        {"settings.capture.all",
         [](const AppSettings& s) { return s.screenCapture == ScreenCaptureMode::All; }},
        {"settings.capture.pages",
         [](const AppSettings& s) { return s.screenCapture == ScreenCaptureMode::Pages; }},
        {"settings.capture.none",
         [](const AppSettings& s) { return s.screenCapture == ScreenCaptureMode::None; }},
