...
- Windows
- Optional: a [Tobii Eye Tracker 5](https://www.tobii.com/) with its drivers. Without hardware, Gazer uses the **mouse** as the gaze point (tray / Settings → Assist → tracker).
